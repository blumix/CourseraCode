...
public class Point implements Comparable<Point> {
    ...
    public int compareTo(Point that) {
        return y == that.y ? Integer.compare(x, that.x) :
               Integer.compare(y, that.y);
    }
    ...
    private class PointsComparator implements Comparator<Point> {
        ...
        private PointsComparator(Point cur) {
            this.cur = cur;
        }

        @Override
        public int compare(Point o1, Point o2) {
            double first = cur.slopeTo(o1);
            double second = cur.slopeTo(o2);
